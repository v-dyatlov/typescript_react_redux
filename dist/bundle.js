...
var PrivateRoute_1 = __webpack_require__(/*! ./PrivateRoute */ "./src/components/PrivateRoute.tsx");
var LoginPage_1 = __webpack_require__(/*! ./LoginPage */ "./src/components/LoginPage.tsx");
var HomePage_1 = __webpack_require__(/*! ./HomePage */ "./src/components/HomePage.tsx");
var MapPage_1 = __webpack_require__(/*! ./MapPage */ "./src/components/MapPage.tsx");
        ...
        return React.createElement("div", null,
            React.createElement(react_router_dom_1.Router, { history: history_1.history },
                React.createElement("div", null,
                    React.createElement(PrivateRoute_1.PrivateRoute, { exact: true, path: "/", component: HomePage_1.HomePage }),
                    React.createElement(react_router_dom_1.Route, { path: "/login", component: LoginPage_1.LoginPage }),
                    React.createElement(react_router_dom_1.Route, { path: "/map", component: MapPage_1.MapPage }))));
    };
    return App;
}(React.Component));
exports.App = App;
...
var HomePage = /** @class */ (function (_super) {
    ...
    HomePage.prototype.render = function () {
        return React.createElement("div", null,
            ...
            React.createElement(react_router_dom_1.Link, { to: "/map" }, "Show account with amount >= 1000 on the map"));
    };
    return HomePage;
}(React.Component));
...
var auth_actions_1 = __webpack_require__(/*! ../redux/auth/auth.actions */ "./src/redux/auth/auth.actions.ts");
var auth_service_1 = __webpack_require__(/*! ../redux/auth/auth.service */ "./src/redux/auth/auth.service.ts");
var history_1 = __webpack_require__(/*! ../history */ "./src/history.ts");
var LoginPage = /** @class */ (function (_super) {
    ...
    LoginPage.prototype.handleChange = function (e) {
        var _a;
    ...
    LoginPage.prototype.handleSubmit = function (e) {
        ...
        dispatch(auth_actions_1.loginRequest(true));
        var user = {
            login: this.state.username,
            password: this.state.password
        };
        var result = auth_service_1.AuthService.login(user);
        if (result) {
            dispatch(auth_actions_1.loginSuccess(user));
            history_1.history.push('/');
        }
        else {
            // login fail
            dispatch(auth_actions_1.loginSuccess);
        }
    };
    LoginPage.prototype.render = function () {
        return React.createElement("div", null,
            ...
            this.props.loggingIn &&
                React.createElement("div", null, "Woo-hoo login request is send"));
    };
    return LoginPage;
}(React.Component));
function mapStateToProps(state) {
    var loggingIn = state.auth.loggingIn;
    return {
        loggingIn: loggingIn
    };
}
var connectedLoginPage = react_redux_1.connect(mapStateToProps)(LoginPage);
...
var React = __webpack_require__(/*! react */ "react");
var react_redux_1 = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
var map_service_1 = __webpack_require__(/*! ../redux/map/map.service */ "./src/redux/map/map.service.ts");
var react_router_dom_1 = __webpack_require__(/*! react-router-dom */ "./node_modules/react-router-dom/es/index.js");
var MapPage = /** @class */ (function (_super) {
    ...
    MapPage.prototype.componentDidMount = function () {
        var dispatch = this.props.dispatch;
        map_service_1.MapService.getAccounts(dispatch);
    };
    MapPage.prototype.render = function () {
        return React.createElement("div", null,
            React.createElement(react_router_dom_1.Link, { to: "/" }, "Back"),
            React.createElement("div", { id: "map" }));
    };
    return MapPage;
}(React.Component));
function mapStateToProps(state) {
    var accounts = state.map.accounts;
    return {
        accounts: accounts
    };
}
var connectedMapPage = react_redux_1.connect(mapStateToProps)(MapPage);
exports.MapPage = connectedMapPage;
...
var redux_2 = __webpack_require__(/*! ./redux */ "./src/redux/index.ts");
var loggerMiddleware = redux_logger_1.createLogger();
function configureStore() {
    return redux_1.createStore(redux_2.reducers, redux_1.applyMiddleware(redux_thunk_1.default, loggerMiddleware));
}
...
var configureStore_1 = __webpack_require__(/*! ./configureStore */ "./src/configureStore.ts");
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.loginRequest = function (loggingIn) { return ({
...
/***/ "./src/redux/auth/auth.reducer.ts":
/*!****************************************!*\
  !*** ./src/redux/auth/auth.reducer.ts ***!
  \****************************************/
/*! no static exports found */
...
var authReducer = function (state, action) {
    ...
    switch (action.type) {
        ...
        case '@@auth/LOGIN_SUCCESS':
            return __assign({}, state, { user: action.payload.user, loggingIn: false });
        default:
            return state;
    }
};
...
/***/ "./src/redux/auth/auth.service.ts":
/*!****************************************!*\
  !*** ./src/redux/auth/auth.service.ts ***!
  \****************************************/
/*! no static exports found */
...
var redux_1 = __webpack_require__(/*! redux */ "./node_modules/redux/es/redux.js");
//reducers
var auth_reducer_1 = __webpack_require__(/*! ./auth/auth.reducer */ "./src/redux/auth/auth.reducer.ts");
var map_reducer_1 = __webpack_require__(/*! ./map/map.reducer */ "./src/redux/map/map.reducer.ts");
exports.reducers = redux_1.combineReducers({
    auth: auth_reducer_1.default,
    map: map_reducer_1.default
});


/***/ }),

/***/ "./src/redux/map/map.actions.ts":
/*!**************************************!*\
  !*** ./src/redux/map/map.actions.ts ***!
  \**************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var MapConstants = __webpack_require__(/*! ./map.constants */ "./src/redux/map/map.constants.ts");
exports.mapRequest = function () { return ({
    type: MapConstants.MAP_REQUEST,
    payload: {},
}); };
exports.mapSuccess = function (account) { return ({
...
/***/ "./src/redux/map/map.constants.ts":
/*!****************************************!*\
  !*** ./src/redux/map/map.constants.ts ***!
  \****************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.MAP_REQUEST = "MAP_REQUEST";
exports.MAP_SUCCESS = "MAP_SUCCESS";


/***/ }),

/***/ "./src/redux/map/map.reducer.ts":
/*!**************************************!*\
  !*** ./src/redux/map/map.reducer.ts ***!
  \**************************************/
/*! no static exports found */
...
var mapReducer = function (state, action) {
    if (state === void 0) { state = exports.initialState; }
    switch (action.type) {
        case '@@map/MAP_REQUEST':
            return __assign({}, state, { accounts: [] });
        case '@@map/MAP_SUCCESS':
            return __assign({}, state, { accounts: state.accounts.concat([action.payload.account]) });
        default:
            return state;
    }
};
...
Object.defineProperty(exports, "__esModule", { value: true });
var map_actions_1 = __webpack_require__(/*! ./map.actions */ "./src/redux/map/map.actions.ts");
var openSocket = __webpack_require__(/*! socket.io-client */ "./node_modules/socket.io-client/lib/index.js");
...
function getAccounts(dispatch) {
    var _this = this;
    dispatch(map_actions_1.mapRequest());
    var map = this.initMap();
    socket.emit('get_markers');
    socket.on('marker', function (account) {
        dispatch(map_actions_1.mapSuccess(account));
        _this.addMarker(account, map);
    });
}
function addMarker(account, map) {
    var coordinates = getCoordinates(account.address);
